...
The traffic signal timing is adjusted dynamically according to the traffic conditions.
This enables adaptive traffic management without requiring cloud processing, making the system faster and more efficient. 
